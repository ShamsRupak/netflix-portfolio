...
export const projectsData: Project[] = [
  {
    title: 'StreamForge',
    description: 'Rust event streaming engine built from scratch. Commit log, TCP broker, wire protocol, producer/consumer SDKs, LZ4 compression, consumer groups. 73 tests, 304K records/sec throughput.',
  ...
  {
    title: 'TinyLang',
    description: 'C++20 compiled programming language from scratch. Lexer, Pratt parser, type inference, 28-opcode bytecode compiler, stack-based VM with mark-sweep GC. 112 tests, 6 example programs.',
  ...
  {
    title: 'Nexus',
    description: 'Enterprise AI agent orchestration platform. 6 modules (core/connect/train/eval/observe/api), LoRA fine-tuning for Qwen-2.5, 207 tests, 34 commits.',
  ...
  {
    title: 'SentinelBoard',
    description: 'FastAPI + React + WebSocket ML monitoring dashboard with PSI drift detection, Prometheus metrics, 47 tests. Live deployed on Render.',
  ...
  {
    title: 'PulseAPI',
    description: 'Production-grade REST API with FastAPI, PostgreSQL, Redis caching, Docker containerization, and comprehensive test coverage.',
  ...
  },
  {
    ...
    description: 'XGBoost-based weather prediction system achieving 81.4% accuracy on NYC weather data with feature engineering and hyperparameter optimization.',
